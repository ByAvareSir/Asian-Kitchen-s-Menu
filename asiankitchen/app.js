...
const EveryFood = () => {
    let EveryFoods = ""
    menu.map(item => {
        EveryFoods += createFoods(item)
    })
    menuDOM.innerHTML = EveryFoods
}
document.addEventListener("DOMContentLoaded", EveryFood)
document.querySelector("#all").addEventListener("click", EveryFood);
...
document.querySelector("#korea").addEventListener("click", KoreanFood);
...
document.querySelector("#japan").addEventListener("click", JapaneseFood);
...
document.querySelector("#china").addEventListener("click", ChineseFood);